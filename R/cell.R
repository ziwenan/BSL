...
#' @param Y        A \code{rows} by \code{cols} by \code{num_obs} array of the cell presences at times \code{1:num_obs} (not time 0).
#' @param Yinit    The initial matrix of cell presences of size \code{rows} by \code{cols}.
...
#' The function \code{cell_prior(theta)} evaluates the log prior at the chosen parameters.
#' @rdname cell
#' @export
cell_logPrior <- function(theta) {
