...
#' \item \code{logitTransform}: A logical argument indicating whether a logit transformation is used in the algorithm.
...
#' \item \code{thetaNames}: A character vector of parameter names.
